...
namespace DatabaseComparisonLogic.Comparison
{
    ...
    public class ComparisonStoredProcedures : BaseComparison, IComparable
    {
        private string _sqlQuery = "SELECT name FROM sqlite_master WHERE type = 'procedure'";

        public ComparisonStoredProcedures()
        {
        ...
        public ComparisonStoredProcedures(SQLiteConnection firstSQLiteConnection, SQLiteConnection secondSQLiteConnection)
        {
